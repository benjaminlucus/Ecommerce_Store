        ...
        <div className='relative' onMouseLeave={onMouseLeave} onMouseEnter={onMouseEnter} ref={dropdownRef}>
            <div>
                ...
                {category.subcategories && category.subcategories.length > 0 &&
                    <div className={`opacity-0 absolute border-b-[10px] -bottom-3 w-0 h-0 border-l-[10px] border-r-[10px] border-l-transparent border-r-transparent border-b-black left-1/2  ${isOpen && "opacity-100"}`} />
                }
            </div>
